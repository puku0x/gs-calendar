 ...
 *  施設グループリスト取得
 */
public class GetFacilityGroupListTask extends AsyncTask<String, Void, List<FacilityGroupData>> {
    private final Context context;
    Exception exception;

    public GetFacilityGroupListTask(Context context) {
        this.context = context;
    }

    @Override
    protected List<FacilityGroupData> doInBackground(String... params) {
        try {
            // ログイン情報を取得
            ...
            return new GroupSessionApi(login).getFacilityGroupList();
