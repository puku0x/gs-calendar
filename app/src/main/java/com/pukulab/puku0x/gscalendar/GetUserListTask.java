 ...
 * ユーザリスト取得タスク
 */
public class GetUserListTask extends AsyncTask<GroupData, Void, List<UserData>> {
    ...
    @Override
    protected List<UserData> doInBackground(GroupData... params) {
        try {
            // ログイン情報を取得
            ...
            //
            GroupData group = params[0];
            return new GroupSessionApi(login).getUserList(group.id);
