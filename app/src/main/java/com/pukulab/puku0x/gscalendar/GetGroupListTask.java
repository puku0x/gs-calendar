 ...
 * グループリスト取得タスク
 */
public class GetGroupListTask extends AsyncTask<String, Void, List<GroupData>> {
    private final Context context;
    Exception exception;

    public GetGroupListTask(Context context) {
    ...
    protected List<GroupData> doInBackground(String... params) {
        try {
            ...
            return new GroupSessionApi(login).getGroupList();
