...
public class TitlePageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultTextSize = res.getDimension(com.vdesmet.lib.calendar.R.dimen.lib_default_title_indicator_text_size);
        final float defaultTitlePadding = res.getDimension(com.vdesmet.lib.calendar.R.dimen.lib_default_title_indicator_title_padding);
        final float defaultClipPadding = res.getDimension(com.vdesmet.lib.calendar.R.dimen.lib_default_title_indicator_clip_padding);
        final float defaultTopPadding = res.getDimension(com.vdesmet.lib.calendar.R.dimen.lib_default_title_indicator_top_padding);
