...
public abstract class AbstractCalendarView extends LinearLayout {
     ...
     * @see DayStyleFactory DayStyleFactory: Check the available values
     */
    ...
    protected int getAvailableDayWidth(int width) {
        ...
        final int maxWidthPerTile =
                getResources().getDimensionPixelSize(R.dimen.lib_calendar_day_width);
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if(resizeWidth) {
            ...
            dayWidth = getResources().getDimensionPixelSize(R.dimen.lib_calendar_day_width);
        }  else {
     ...
     *
     * @param dayInMillis The time in milliseconds
     * @return The Linear representing the entered date
     */
    public abstract LinearLayout getCategoryViewForDate(final long dayInMillis);
}
